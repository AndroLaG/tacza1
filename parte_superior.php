...
<head>
  ...
  <meta name="viewport" content="width=device-width, initial-scale=1">
    <!-- App favicon -->
    <link rel="shortcut icon" href="../img/logo-png-redser.png">
  <title>Sistema de ventas | Sisventas</title>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color:green;">
    ...
    <ul class="navbar-nav">
      ...
      <li class="nav-item d-none d-sm-inline-block">
        <a href="home.php" class="nav-link" class="btn btn-dark" style="color:white">Home</a>
      </li>      
    </ul>    
  ...
  <div class="content-wrapper">
      ...
      <section class="content-header">
        <div class="container-fluid">
          <div class="row mb-2">
            <div class="col-sm-6">
              <h1>Bienvenidos al Sistema de Ventas REDSERVCOM</h1>
            </div>
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                <li class="breadcrumb-item"><a href="#">Home</a></li>
                <li class="breadcrumb-item active">REDSERVCOM</li>
              </ol>
            </div>
          </div>
        </div><!-- /.container-fluid -->
